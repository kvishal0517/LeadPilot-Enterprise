...
export default function StatsCard({ label, value, icon: Icon, trend, color = "primary", subtitle }) {
  ...
  return (
    <div className="surface-container hover:shadow-md hover:-translate-y-1">
      ...
      <div>
        <h3 className="text-4xl font-google font-bold tracking-tight text-slate-800 mb-1">{value}</h3>
        <p className="text-sm font-google font-medium text-slate-500 uppercase tracking-wide">{label}</p>
